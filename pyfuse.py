...
class FuseBridge(object):
    ...
    def _main(self, argv):
        ...
        if sys.platform != "darwin":
            fuse_opts += ["direct_io", "auto_unmount"]
    ...
    def main(self, argv):
        ...
        self.pool = pathos.multiprocessing.Pool(processes=1)
        self.process = self.pool.apply_async(self._main, (argv,))
        ...
        sys.stdout.write("%s"%(self.process.get()))
