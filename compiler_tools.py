...
ERRNO_CONSTANTS = find_and_get_constants("/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/errno.h", "^E")
FCNTL_CONSTANTS = find_and_get_constants("/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/fcntl.h", "^[A-Z]")
STAT_CONSTANTS = find_and_get_constants("/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/stat.h", "^[A-Z]")
